            ...
            <div class="w-2/5 mx-auto my-10 rounded overflow-hidden shadow-lg">
                ...
                <div class="d-flex justify-center flex-row px-6 py-4">
                   <form action="/reserver" method="post">
                    ...
                    <input type="number" name="nombre_de_place" class="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md">
                    <button type="submit" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline">Reserver</button>
